...
import useEmployeeEditHook from "./NewEmployeeEditHook";
import constants from "../../../../config/constants";
import ChildrenIncludeForm from "../../../EmployeeList/components/includes/ChildrenIncludes.component";
...
import RejectDialog from "./ConfirmationDialog/RejectDialog.view";
import AcceptDialog from "./AcceptDialog/AcceptDialog.view";
    ...
    <div>
      ...
      <div className={"plainPaper"}>
        ...
        <div
          className={"formFlex"}
          style={{ width: "50%" }}
          id={styles.mobileResponsiveData}
        >
          <div className={"formGroup"}>
            <CustomTextField
            ...
            <div className={"formGroup"}>
              <CustomTextField
                ...
                disabled={
                  ...
                  form?.fuel ||
                  (form?.is_two_car_maintenance_manual === "NO" ? true : false)
                }
            ...
            <div style={{ display: "flex" }}>
              <CustomTextField
                disabled={
                  form?.vehicle_maintenance ||
                  form?.fuel ||
                  (form?.is_two_fuel_manual === "NO" ? true : false)
                }
      ...
      <div className={"plainPaper"}>
        <div className={styles.lowerWrap} id={styles.wrapperValueData}>
...
export default NewEmployeeEdit;
