      ...
      <div className={styles.punchInOutSubContainer}>
        <div className={styles.itemFlex}>
          ...
          <div className={styles.subBoxContainer}>
            ...
            <div className={isSwip === "true" ? styles.punchTimeTextPunchIn : styles.punchTimeText}>Punch In</div>
          </div>
        </div>
        <div className={styles.itemFlex}>
        <img src={punchOut} alt="" className={styles.punchImage}/>
          <div className={styles.subBoxContainer}>
            <div className={styles.punchTime}>{isLeftSwip ? punchOutTime : "__"}</div>
            <div className={isLeftSwip === "true" ? styles.punchTimeTextPunchIn : styles.punchTimeText}>Punch Out</div>
          </div>
        </div>
      </div>
    </div>
