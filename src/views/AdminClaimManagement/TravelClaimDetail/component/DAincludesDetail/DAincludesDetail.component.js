...
import DAincludesDetailFields from "./DAincludesDetailFields.component";
...
const DAincludesDetailForm = (
  ...
  const sum = fields.reduce((acc, obj) => {
...
export default forwardRef(DAincludesDetailForm);
