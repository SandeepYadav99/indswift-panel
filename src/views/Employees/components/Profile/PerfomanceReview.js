                ...
                <div className={styles.newContainer}>
                    ...
                    <div className={styles.mainFlex}>
                        ...
                        <div className={styles.right}>
                            <div className={styles.key}><span className={styles.value}>Reviewer Name:</span>Sankalp Singh</div>
                            <div className={styles.key}><span className={styles.value}>Employee Code:</span>123456</div>
                        </div>
                    </div>
