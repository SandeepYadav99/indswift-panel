...
import {
  actionFetchCloneFinalFormApproval,
  actionSetPageCloneFinalFormApproval,
} from "../../../actions/CloneFinalFormApproval.action";
import historyUtils from "../../../libs/history.utils";
import LogUtils from "../../../libs/LogUtils";
import RouteName from "../../../routes/Route.name";
import { serviceGetList } from "../../../services/Common.service";
import { serviceGetFinalFormExport } from "../../../services/CloneFinalFormApproval.service";

const useCloneFullFinalApproval = ({}) => {
  ...
  } = useSelector((state) => state.clone_final_form_approval);
  useEffect(() => {
    dispatch(
      actionFetchCloneFinalFormApproval(1, sortingData, {
  ...
  const handlePageChange = useCallback((type) => {
    ...
    dispatch(actionSetPageCloneFinalFormApproval(type));
  }, []);

  const queryFilter = useCallback(
    (key, value) => {
      // dispatch(actionSetPageCloneFinalFormApprovalRequests(1));
      dispatch(
        actionFetchCloneFinalFormApproval(1, sortingData, {
  ...
  const handleSortOrderChange = useCallback(
    (row, order) => {
      ...
      // dispatch(actionSetPageCloneFinalFormApproval(1));
      dispatch(
        actionFetchCloneFinalFormApproval(
          1,
          { row, order },
...
export default useCloneFullFinalApproval;
