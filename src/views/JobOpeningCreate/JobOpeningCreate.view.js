  ...
  return (
    <div>
      ...
      <div className={"plainPaper"}>
        ...
        >
          <div className="formGroup"  id={styles.widthFieldAdjustDataValue} >
            <CustomAutoComplete
              autoCompleteProps={{
                freeSolo: false,
        ...
        <div className={styles.btm}>
          <div className={styles.toggleBtn}>
            <div>
              <CustomToggle
                value={form?.is_sourcing}
                handleChange={() => {
                  changeTextData(!form?.is_sourcing, "is_sourcing");
                }}
                leftLabel={"Not Sourcing"}
                rightLabel={"Sourcing"}
              />
            </div>
