...
import TravelDetailsIncludeFields from "./TravelDetailsIncludeFields.component";
...
const TravelDetailsIncludeForm = (
  {
    data,
    currency,
    listWarehouse,
  ...
  const changeData = (index, data, dateValue) => {
    ...
    if (dateValue) {
      tempData.forEach((item) => (item.interview_date = ""));
    } else {
...
export default forwardRef(TravelDetailsIncludeForm);
