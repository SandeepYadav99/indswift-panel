...
import useLoanApproveDialogHook from "./LoanApproveDialog.hook";
...
const LoanApproveDialog = ({ isOpen, handleToggle, candidateId ,isInterview}) => {
  ...
  const {
    ...
    setDeclaration,
    declaration,
  } = useLoanApproveDialogHook({ isOpen, handleToggle, candidateId ,isInterview});
        ...
        <div className={styles.resetPasswordWrapper}>
          ...
          <div className={styles.headingWrapper}>
            ...
            <div className={styles.des}>
              Do you approve the documents and the Loan amount.
            </div>
          </div>
...
export default LoanApproveDialog;
