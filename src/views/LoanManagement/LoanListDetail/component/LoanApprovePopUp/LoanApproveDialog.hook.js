...
import { serviceApproveEmployeeLoan } from "../../../../../services/LoanList.service";

const initialForm={
  comment:"",
}
const useLoanApproveDialogHook = ({ isOpen, handleToggle ,candidateId}) => {
...
export default useLoanApproveDialogHook;
