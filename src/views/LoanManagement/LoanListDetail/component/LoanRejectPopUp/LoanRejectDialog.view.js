...
import useLoanRejectDialogHook from "./LoanRejectDialog.hook";
...
const LoanRejectDialog = ({ isOpen, handleToggle, candidateId }) => {
  ...
  const {
    ...
    setDeclaration,
    declaration
  } = useLoanRejectDialogHook({ isOpen, handleToggle, candidateId });
        ...
        <div className={styles.resetPasswordWrapper}>
          ...
          <div className={styles.headingWrapper}>
            ...
            <div className={styles.des}>
              Do you Reject the documents and the Loan amount.
            </div>
          </div>
...
export default LoanRejectDialog;
