...
import useLoanCloseDialogHook from "./LoanCloseDialog.hook";
...
const LoanCloseDialog = ({ isOpen, handleToggle, candidateId }) => {
  ...
  const {
    ...
    setDeclaration,
    declaration,
  } = useLoanCloseDialogHook({ isOpen, handleToggle, candidateId });
        ...
        <div className={styles.resetPasswordWrapper}>
          ...
          <div className={styles.headingWrapper}>
            ...
            <div className={styles.des}>
              Are you sure you want to close this processed loan application
            </div>
          </div>
