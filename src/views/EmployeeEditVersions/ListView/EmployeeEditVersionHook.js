...
const useEmployeeVersionList = ({}) => {
    ...
    const {sorting_data: sortingData, is_fetching: isFetching, query, query_data: queryData} = useSelector(state => state.employee_versions);
    ...
    const handleSortOrderChange = useCallback((row, order) => {
        ...
        dispatch(actionFetchEmployeeVersion(1, {row, order}, {
            query: query,
