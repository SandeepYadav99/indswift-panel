...
const validate = (values) => {
    ...
    if (values.website_link && !/^(https?|http):\/\/[^\s$.?#].[^\s]*$/ig.test(values.website_link)) {
                ...
                <form onSubmit={handleSubmit(this._handleSubmit)} className={styles.userForm}>
                    ...
                    <div className={'formFlex'}>
                        <div className={'formGroup'}>
                            <div>
                                <Field fullWidth={true} name="company_name" component={renderOutlinedTextField}
                                       margin={'dense'}
                                       label="Company Name"/>
                            </div>
                        </div>
                    ...
                    <div className="formFlex">
                        <div className="formGroup">
                            <Field fullWidth={true} name="website_link" component={renderOutlinedTextField}
                                   margin={'dense'}
                                   type={'url'}
                                   label="Website Link"/>
                        </div>
                    ...
                    <div className={'formFlex'}>
                        <div className={'formGroup'}>
                            <Field fullWidth={true} name="type" component={renderOutlinedSelectField}
                                   margin={'dense'}
                                   label=" Type">
                                <MenuItem value={'A'}>A</MenuItem>
                            </Field>
                    ...
                    <div className={'formFlex'}>
                        <div className={'formGroup'}>
                            <Field fullWidth={true} name="gst" component={renderOutlinedTextField}
                                   margin={'dense'}
                                   label="GST"/>
                        </div>
                        <div className={'formGroup'}>
                            <Field fullWidth={true} name="registration" component={renderOutlinedTextField}
                                   margin={'dense'}
                                   label="Registration"/>
                        </div>
                    </div>
