...
import {
  actionDeleteFinalForm,
  actionFetchFinalForm,
  actionSetPageFinalForm,
} from "../../actions/FinalForm.action";
...
const useFullFinal = ({}) => {
  ...
  useEffect(() => {
    dispatch(
      actionFetchFinalForm(1, sortingData, {
  ...
  const handlePageChange = useCallback((type) => {
    ...
    dispatch(actionSetPageFinalForm(type));
  }, []);
