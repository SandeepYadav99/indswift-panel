...
import useNoramlizeDialogHook from "./NoramlizeDialog.hook";
...
const NoramlizeDialog = ({ isOpen, handleToggle, candidateId }) => {
  ...
  const {
    ...
    setDeclaration,
    declaration,
  } = useNoramlizeDialogHook({ isOpen, handleToggle, candidateId });
...
export default NoramlizeDialog;
