...
import {serviceLocationRoleDepartments} from "../../../../../services/Location.service";
import WaitingComponent from "../../../../../components/Waiting.component";
import LocIncludeFields from './LocIncludeFields.component';
...
const LocIncludeForm = ({data, employees, locationId, departments, errorData: errorForm, form, changeTextData, handleUpdate}, ref) => {
    ...
    useEffect(() => {
        setIsFetching(true);
        serviceLocationRoleDepartments({location_id: locationId}).then(res => {
                if (!res.error) {
                    const data = res?.data;
                    setFields(data.map(val => {
                        return {
                            department_id: val.role,
...
export default forwardRef(LocIncludeForm);
