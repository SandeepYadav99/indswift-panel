...
const usePayslipsGenerationHook = ({}) => {
  ...
  const [showSlipData, setShowSlipData] = useState(false);
  ...
  const handleSortOrderChange = useCallback(
    (row, order) => {
      ...
      // I did commit need to re add for pagination
      // dispatch(
  ...
  const handleToggleSlipDetail = useCallback(() => {
    setShowSlipData(true);
  }, [setShowSlipData]);
...
export default usePayslipsGenerationHook;
