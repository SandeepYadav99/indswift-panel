...
import useRejectAuthDialogHook from "./RejectAuthDialog.hook";
...
const RejectAuthDialog = ({ isOpen, handleToggle, candidateId }) => {
  ...
  const {
    ...
    setDeclaration,
    declaration
  } = useRejectAuthDialogHook({ isOpen, handleToggle, candidateId });
...
export default RejectAuthDialog;
