...
const AccountDialog = ({ isOpen, handleToggle, candidateId, listData }) => {
  const classes = useStyles();
  const { changeTextData, errorData, form, handleSubmit, isSubmitting } =
    useAccountDialogHook({ isOpen, handleToggle, candidateId, listData });
  return (
    <div>
      <Dialog
