    ...
    return (
        <div className={classes.bgWhite}>
            <div className={classes.upperFlex}>
                <div>New Orders for today</div>
                <b className={classes.value}>0</b>
            </div>
            <div>
                <TableContainer className={classes.container}>
                    <Table stickyHeader className="mb-0">
                        <TableHead>
                            <TableRow>
                                <TableCell className={classes.row}>VENDOR</TableCell>
...
export default VendorsOrdersTable
