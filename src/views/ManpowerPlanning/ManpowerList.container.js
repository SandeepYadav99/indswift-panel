...
// import InfoView from './ManpowerView/ManpowerInfo.view';
...
const ManpowerList = ({}) => {
    const { handleSortOrderChange , handleRowSize, handlePageChange, handleDataSave, handleDelete, handleEdit,
        ...
        isInfoPanel,handleSideInfo,selectedManpowerId} = useManpowerList({});
    ...
    const tableStructure = useMemo(() => {
        return [
            ...
            },
            {
                ...
                label: 'Action',
                render: (temp, all) => (<div>
                    {/*onClick={() => {handleSideInfo(all)}}*/}
                    <IconButton className={'tableActionBtn'} color='secondary' disabled={isCalling} ><InfoOutlined fontSize={'small'} /></IconButton >
                </div>),
            },
    ...
    return (
        <div>
            ...
            <SidePanelComponent
                ...
                title={'Dispatch Info'} open={isSidePanel} side={'right'}>
                {/*{renderCreateForm}*/}
            </SidePanelComponent>
            <SidePanelComponent
                handleToggle={handleSideInfo}
                title={'Pending Dispatch Detail'} open={isInfoPanel} side={'right'}>
                {/*{renderInfoForm}*/}
            </SidePanelComponent>
        </div>
    )
