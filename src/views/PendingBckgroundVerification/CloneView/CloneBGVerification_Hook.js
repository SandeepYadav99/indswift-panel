...
import {
  ...
  actionSetPageCloneBGVList,
} from "../../../actions/CloneBGVerification.action";
...
const useCloneBGVerification_Hook = () => {
  ...
  } = useSelector((state) => state?.clone_pendingBGV);

  useEffect(() => {
    dispatch(
      actionFetchCloneBGVList(1, sortingData, {
  ...
  const handlePageChange = useCallback((type) => {
    dispatch(actionSetPageCloneBGVList(type));
  }, []);
...
export default useCloneBGVerification_Hook;
