...
import useCloneBGVerification_Hook from "./CloneBGVerification_Hook";

const CloneBGVerification_View = ({ location }) => {
  const {
    ...
    setLocationId,
  } = useCloneBGVerification_Hook({ location });
...
export default CloneBGVerification_View;
