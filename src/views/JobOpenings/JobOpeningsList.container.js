  ...
  const tableStructure = useMemo(() => {
    return [
      ...
      },
      {
        ...
        sortable: false,
        render: (temp, all) => (
          <div>{all?.is_recurring ? all?.total_vacancies : 1}</div>
        ),
      },
      {
        key: "assigned_to",
      ...
      },
      {
        ...
        sortable: false,
        render: (temp, all) => (
          <div>{all?.total_candidates ? all?.total_candidates : 0}</div>
        ),
      },
      {
        key: "closedAt",
      ...
      },
      {
        ...
        render: (temp, all) => (
          <div>
            {renderStatus(all?.is_sourcing ? "SOURCING" : "NOSOURCING")}
            <br />
            <br />
