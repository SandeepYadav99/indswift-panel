...
import EmployeeIncludeFields from './IncludeFields.component';
...
const EmployeeIncludeForm = ({data, currency, listWarehouse, errorData: errorForm, form, changeTextData, updateInventory, vendorId}, ref) => {
    ...
    const renderFields = useMemo(() => {
        return fields.map((val, index) => {
            ...
            return (
                <div>
                <EmployeeIncludeFields  variants={tempFilters}
